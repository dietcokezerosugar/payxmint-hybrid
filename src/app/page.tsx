    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-32">
        ...
        <section className="container mx-auto px-6 text-center mb-24">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-in fade-in slide-in-from-bottom-8 delay-200 duration-1000">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-in fade-in slide-in-from-bottom-8 delay-300 duration-1000">
            <Link href="/dashboard" className="px-8 py-4 bg-primary text-white rounded-full text-lg font-semibold flex items-center gap-2 hover:gap-3 transition-all">
              Get Started <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="#features" className="px-8 py-4 bg-secondary text-foreground rounded-full text-lg font-semibold hover:bg-gray-200 transition-all">
              View Features
            </Link>
          </div>
        </section>
